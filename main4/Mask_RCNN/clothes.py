...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "trousers")
        self.add_class("object", 2, "vest")
        self.add_class("object", 3, "short sleeve dress")
        self.add_class("object", 4, "short sleeve top")
        self.add_class("object", 5, "shorts")
        self.add_class("object", 6, "long sleeve top")
